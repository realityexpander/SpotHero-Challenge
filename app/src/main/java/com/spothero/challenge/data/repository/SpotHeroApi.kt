...
//     * @see Spot
//     */
//    suspend fun getSpots(): List<SpotDTO> = client.get<List<SpotDTO>> {
//        endpoint("/spots")
//    }.map { spot ->
//        spot.apply {
...
//     * @see Spot
//     */
//    fun getSpotsObservable() = Single.create<List<SpotDTO>> { emitter ->
//        GlobalScope.launch {
...
//     * @see Spot
//     */
//    suspend fun getSpotById(spotId: Int): SpotDTO? = getSpots().firstOrNull {
//        it.id == spotId
//    }
...
//     * @see Spot
//     */
//    fun getSpotByIdObservable(spotId: Int) = Single.create<SpotDTO> { emitter ->
//        GlobalScope.launch {
